...
- Ya trabaja con clientes reales (sistema de inmobiliaria con React + Django, gestión de stock con Next.js + Supabase, pasarela de pagos y herramienta de análisis de trading en Cryptory).
